...
/*
	...
	See https://github.com/worldnuqumoritytransporters/wnt-headless/wiki/Running-RPC-service for detailed description of the API
*/
...
var mutex = require('wntcore/mutex.js');
var storage = require('wntcore/storage.js');
var constants = require('wntcore/constants.js');
var validationUtils = require("wntcore/validation_utils.js");
var wallet_id;
...
function initRPC() {
	...
	var walletDefinedByKeys = require('wntcore/wallet_defined_by_keys.js');
	var Wallet = require('wntcore/wallet.js');
	var balances = require('wntcore/balances.js');
